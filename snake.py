...
# Background Image
bgimg = pygame.image.load("/Users/vatsalgajjar/Downloads/space.jpeg")
bgimg = pygame.transform.scale(
    bgimg, (screen_width, screen_height)).convert_alpha()


# Game Title
pygame.display.set_caption("Snake Game By Vatsal")
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    pygame.mixer.music.load(
                        '/Users/vatsalgajjar/Downloads/backgroundmusic.mp3')
    ...
    while not exit_game:
        if game_over:
            ...
            if head in snk_list[:-1]:
                game_over = True
                pygame.mixer.music.load(
                    '/Users/vatsalgajjar/Downloads/gameover.mp3')
                pygame.mixer.music.play()
